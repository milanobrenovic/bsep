...
export class Certificate {
  ...
  public keyUsageDTO: KeyUsage;
	...
	constructor(subjectId: number, issuerId: number, startDate: Date, endDate: Date, alias: string, password: string, keyStorePassword: string, keyUsageDTO: KeyUsage, extendedKeyUsageDTO: ExtendedKeyUsage) {
